...
QT_MOC_LITERAL(1, 4, 11), // "changeLabel"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 4), // "data"
QT_MOC_LITERAL(4, 22, 15), // "web_changeLable"
QT_MOC_LITERAL(5, 38, 7) // "recvmsg"

    },
    "tcp\0changeLabel\0\0data\0web_changeLable\0"
    "recvmsg"
};
...
void tcp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->web_changeLable((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tcp::changeLabel)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (tcp::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tcp::web_changeLable)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void tcp::changeLabel(QString _t1)
{
...
// SIGNAL 1
void tcp::web_changeLable(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
